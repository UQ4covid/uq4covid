...
metawards -d ncov -o output1 --force-overwrite-output --input disease1.csv -a ExtraSeedsLondon.dat --repeats 5 --extractor ..\..\tools\output_extractors\only_i_per_ward -u defs\lockdown_states.txt --iterator ..\..\tools\lockdown\iterate
