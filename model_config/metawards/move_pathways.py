...
#
# Everyone starts in the General population as susceptible
#
# Valid moves
#   - General population state I2 to Hospital state H1
#   - Hospital population state H2 to Critical care state C1
#
